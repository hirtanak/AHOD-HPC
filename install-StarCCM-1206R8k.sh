...
# create directory
mkdir -p $SHARE_DATA/INSTALLERS/starccm+_12.06.010-R8/
...
echo 'export PATH=$SHARE_DATA/applications/12.06.010-R8/STAR-CCM+12.06.010-R8/star/bin:/opt/intel/impi/5.1.3.223/bin64:$PATH' >> $SHARE_HOME/.bashrc
...
cd $SHARE_DATA/INSTALLERS/starccm+_12.06.010-R8/
sh $SHARE_DATA/INSTALLERS/starccm+_12.06.010-R8/STAR-CCM+12.06.010_01_linux-x86_64-2.5_gnu6.2-r8.sh -i silent -DINSTALLDIR=$SHARE_DATA/applications -DNODOC=true -DINSTALLFLEX=false
